...
class Robot:
    def __init__(self):
        self.xEstFull = np.array([-5.0, -5.0, math.pi/2])
        self.xEstFull[:2] = self.xEstFull[:2] * (1.5/20)
...
if __name__ == "__main__":
    try:
        ...
        robot = Robot()
        time.sleep(3)
        robot.move_to(-5*a, -5*a, 0)
        time.sleep(3)
        robot.move_to(5*a, -5*a, 0)
        time.sleep(3)
        robot.move_to(5*a, -5*a, math.pi/2)
        time.sleep(3)
        robot.move_to(5*a, 5*a, math.pi/2)
        time.sleep(3)
        robot.move_to(5*a, 5*a, -math.pi)
        time.sleep(3)
        robot.move_to(-5*a, 5*a, -math.pi)
        time.sleep(3)
        robot.move_to(-5*a, 5*a, -math.pi/2)
