...
X = np.genfromtxt(r"c:\Users\alber\Desktop\HW5\xEstFull.txt", delimiter=", ")[3:].reshape(-1, 2)
...
print(transform_and_calculate_distance(list(result.x), X, Y)/12)
print(transform_X(result.x, X))